...
Personal Snippets
"""""""""""""""
Through your  `personal menu <simplifierPersonalContent.html>`_ (click on your avatar at the top right and select ``Snippets``) you can access a list of all your Snippets. From here you can also quickly add a new Snippet by clicking the green ``+New`` button.
