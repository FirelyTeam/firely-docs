...
.. caution:: Terminology operations in Vonk 3.0.0 only work for STU3. Starting from Vonk 3.5.0 we provide more elaborate terminology support by integrating with a full Terminology Server, :ref:`Terminology Integration docs<terminologyintegration>`.
