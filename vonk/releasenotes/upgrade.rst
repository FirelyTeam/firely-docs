...
#. Download the latest version of Vonk, see :ref:`vonk_getting_started`, and extract it to where you want it installed.
...
#. Stop the running instance of Vonk (Ctrl + C if running from the console).
